    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {images.map((image, index) => (
          <div
            key={image.id}
            className="relative aspect-square overflow-hidden bg-neon-dark border-2 border-dashed border-neon-grey hover:border-neon-green-light transition-all cursor-pointer group"
      ...
      {selectedImage && (
        ...
        >
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 text-white text-4xl hover:text-neon-green-light transition-colors"
          ...
          <button
            ...
            className="absolute left-4 text-white text-4xl hover:text-neon-green-light transition-colors"
          ...
          <button
            ...
            className="absolute right-4 text-white text-4xl hover:text-neon-green-light transition-colors"
