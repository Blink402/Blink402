      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-5xl">
          <div data-reveal className="space-y-8">
            ...
            <div className="rounded-lg border border-dashed border-neon-green-light/30 bg-neon-dark p-6 md:p-8">
              ...
              <ol className="space-y-3 text-neon-grey">
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-neon-green-light text-xs text-neon-green-light">
                    1
                  </span>
                  <span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    <a
                      ...
                      className="text-neon-green-light underline hover:text-neon-green-dark"
                    >
                      Dog Facts API
                    </a>{' '}
            ...
            <div data-reveal className="text-center">
              ...
              <a
                href="/create"
                className="btn-primary inline-flex items-center gap-2 rounded-lg border-2 border-dashed border-neon-green-light bg-transparent px-8 py-3 font-medium text-neon-green-light transition-all hover:border-neon-green-dark hover:bg-neon-green-light/10 hover:text-neon-green-dark hover:shadow-[0_0_20px_rgba(39,218,180,0.3)]"
              >
                Create a Blink
                <svg
                  className="h-5 w-5"
