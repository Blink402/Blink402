...
export default function ReceiptPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const statusColors = {
    success: "text-neon-green-light border-neon-green-light/40 bg-neon-green-light/10",
      ...
      <section className="px-6 py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="mb-8 font-mono text-sm text-neon-grey" data-reveal>
            <Link href="/" className="hover:text-neon-green-light transition-colors">
              Home
            </Link>
            <span className="mx-2">/</span>
            <Link href="/dashboard" className="hover:text-neon-green-light transition-colors">
              Dashboard
            </Link>
            <span className="mx-2">/</span>
          ...
          <Card className="p-6 bg-neon-dark/40 border-neon-grey/20" data-reveal>
            ...
            <div className="space-y-3 font-mono text-sm">
              ...
              <div>
                ...
                <p className="text-neon-green-light">${receipt.blink.priceUsdc} USDC</p>
              </div>
