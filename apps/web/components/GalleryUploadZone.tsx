    ...
    <div className="mb-8">
      <div
        ...
        className={cn(
          ...
          isDragging
            ? 'border-neon-green-light bg-neon-dark/50'
            : 'border-neon-grey hover:border-neon-green-light',
      ...
      >
        ...
        {isUploading ? (
          <div className="space-y-4">
            <div className="text-neon-green-light text-2xl font-mono">Uploading...</div>
            <div className="w-full bg-neon-dark border border-neon-grey h-2">
              <div
                className="bg-gradient-to-r from-neon-green-light to-neon-green-dark h-full transition-all duration-300"
