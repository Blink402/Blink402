...
function CheckoutPageContent() {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      // Step 2: Deserialize transaction and refresh blockhash
      ...
      // Step 3: Wait for confirmation using polling (avoids WebSocket issues)
      setPaymentState("verifying")

      // Poll for transaction confirmation instead of using WebSocket
      let confirmed = false
      ...
      for (let i = 0; i < maxAttempts; i++) {
        try {
          ...
          logger.debug('Polling attempt', { attempt: i + 1, error: err })
        }
        await new Promise(resolve => setTimeout(resolve, 2000)) // Wait 2 seconds between polls
      }

      if (!confirmed) {
        throw new Error('Transaction confirmation timeout (60s). The transaction may still be processing - please check Solscan for status.')
      }
    ...
    <main className="min-h-screen bg-neon-black">
      <section className="px-6 py-8">
        <div className="max-w-5xl mx-auto">
          {/* Breadcrumb */}
          <div className="mb-8">
            <Link href={`/blink/${slug}`} className="text-neon-green-light hover:text-neon-green-dark font-mono text-sm">
              ← Back to {blink.title}
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              {/* Blink Card */}
              <Card className="bg-neon-dark border-neon-green-dark/20 p-6">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-16 h-16 bg-neon-black border border-neon-green-dark/30 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className="bg-neon-green-dark/20 text-neon-green-light border-neon-green-dark/30">
                        {blink.category}
                      </Badge>
                    </div>
              ...
              {paymentState === "ready" && (
                <Card className="bg-neon-dark border-neon-green-dark/20 p-6">
                  ...
                  <Textarea
                    ...
                    className="bg-neon-black border-neon-green-dark/30 text-neon-white font-mono"
                    rows={6}
                  />
            ...
            <div>
              <Card className="bg-neon-dark border-neon-green-dark/20 p-6 sticky top-8">
                ...
                {paymentState === "idle" && (
                  <div className="space-y-6">
                    <div className="text-center py-8">
                      <div className="w-20 h-20 rounded-full bg-neon-black border border-neon-green-dark/30 flex items-center justify-center mx-auto mb-4">
                        <span className="text-neon text-3xl">🔌</span>
                      </div>
                      <p className="text-neon-grey font-mono text-sm mb-4">Connect your wallet to continue</p>
                ...
                {paymentState === "ready" && (
                  <div className="space-y-6">
                    <Alert className="bg-neon-black border-neon-green-dark/30">
                      <AlertDescription className="text-neon-grey font-mono text-sm">
                        <span className="text-neon-green-light">✓</span> Wallet connected and ready
                      </AlertDescription>
                    </Alert>

                    <div className="bg-neon-black border border-neon-green-dark/30 rounded-lg p-4">
                ...
                {paymentState === "executing" && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-neon-grey font-mono text-xs mt-2">Payment verified ✓</p>
                  </div>
                )}
                  ...
                  <div className="space-y-6">
                    ...
                    {txSignature && (
                      <div className="bg-neon-black border border-neon-green-dark/30 rounded-lg p-4">
                        ...
                        <a
                          ...
                          className="text-neon-green-light font-mono text-xs hover:text-neon-green-dark break-all"
                        >
                          {txSignature}
                        </a>
                      </div>
                    ...
                    {responseData && (
                      <div className="bg-neon-black border border-neon-green-dark/30 rounded-lg p-4">
                        ...
                        <pre className="text-neon-white font-mono text-xs overflow-auto">
                ...
                {paymentState === "cancelled" && (
                  <div className="text-center py-8">
                    <div className="w-20 h-20 rounded-full bg-neon-grey/20 border border-neon-grey flex items-center justify-center mx-auto mb-4">
                      <span className="text-neon-grey text-4xl">⊘</span>
                    </div>
